...
%             addpath(fullfile('SVORIM'));
            ...
            [model_information.predictedTest,model_information.funval] = obj.test(model_information.projectedTest, model);
            c2 = clock;
...
%             rmpath(fullfile('Algorithms','SVORIM'));
	...
	%	    test --> Test struct
        ...
        function [targets,funval] = test(obj, project, model)
