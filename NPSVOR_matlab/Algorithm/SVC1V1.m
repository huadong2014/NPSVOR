...
classdef SVC1V1 < Algorithm
    ...
    %        addpath(fullfile('libsvm-weights-3.12','matlab'));
      addpath('/root/NPSVOR_matlab/Algorithm/libsvm-weights-3.12/matlab');
    ...
    %        rmpath(fullfile('Algorithms','libsvm-weights-3.12','matlab'));
        rmpath('/root/NPSVOR_matlab/Algorithm/libsvm-weights-3.12/matlab');
        end
